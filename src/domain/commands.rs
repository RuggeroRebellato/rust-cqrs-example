...
// TODO: Add the derive macro for the Serialize trait
#[derive(Debug)]
...
// Note that the Deserialize trait is derived. This is not yet needed, but it will be useful when building out a full application. The most common way to receive commands from a user is via an HTTP body that can be directly deserialized.
